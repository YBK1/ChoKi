...
public class NotificationController implements SpringDocNotificationController{
	...
	public ApiResponse deleteNotification(@RequestBody DeleteNotificationRequestDto deleteNotificationRequestDtongCreateRequestDto) {
		notificationService.deleteNotification(deleteNotificationRequestDtongCreateRequestDto.getNotificationId());
		return ApiResponse.success(HttpStatus.OK, "알림 삭제 성공");
	}
}
