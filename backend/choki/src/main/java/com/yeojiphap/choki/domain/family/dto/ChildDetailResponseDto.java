...
public record ChildDetailResponseDto (Long id, String username, String address, String name, String tel, Role role, int level, int exp, int pastLevel, Long mainAnimalId) {
