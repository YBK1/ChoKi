...
const ProductCard: React.FC<ShoppingCardProps> = ({
	...
	const [parentImageSrc, setParentImageSrc] = useState(
		'/icons/waste_basket.svg',
	);
	const [childImageSrc, setChildImageSrc] = useState(
		ChildrenShoppingItem?.image || '/icons/default_image.svg',
	);
			...
			<div className="flex flex-col items-center w-1/2 pr-6 h-full justify-center">
				<div className="w-20 h-20 mb-0 flex items-center justify-center">
					<Image
						...
						width={64}
						height={96}
						onError={() => setParentImageSrc('/icons/default_image.svg')}
					/>
				</div>
					...
					<>
						<div className="w-20 h-20 mb-0 flex items-center justify-center">
							<Image
								...
								width={64}
								height={96}
								onError={() => setChildImageSrc('/icons/default_image.svg')}
							/>
						</div>
						<p className="text-gray-900 font-medium text-lg">
